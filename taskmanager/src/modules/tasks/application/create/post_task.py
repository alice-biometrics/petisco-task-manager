...
from taskmanager.src.modules.tasks.application.create.post_task_error_handler import post_task_error_handler
...
@controller_handler(
    success_handler=lambda result: ({"message": "Created Task", "task_id": str(result.value)}, 200),
